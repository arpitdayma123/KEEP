...
# Update
- **2025.05**: We released the training code and reconstruct the model structure. 
...
You can also download our pretrained models from [Releases V1.0.0](https://github.com/jnjaby/KEEP/releases/tag/v1.0.0) to the `weights` folder.
